class I18n {
    ...
    this.translations = {
      fr: {
        ...
        services: {
          ...
          infrastructure: {
            ...
            description: "Conception et installation de réseaux informatiques adaptés pour votre entreprise.",
          },
          support: {
          ...
          security: {
            ...
            description: "Des solutions fiables et modernes pour sécuriser vos locaux et vos accès.",
          },
          see_more: "Voir plus →",
        },
        industries: {
          title: "— Industries",
          subtitle: "Solutions adaptées à chaque secteur d'activité",
          description1:
      ...
      en: {
        ...
        about: {
          ...
          description1: "MJLINK is a Moroccan company specialized in the integration of IT and digital solutions.",
          description2:
        ...
        services: {
          ...
          infrastructure: {
            ...
            description: "Design and installation of computer networks adapted for your business.",
          },
          support: {
            title: "On-Site IT Support",
            description: "Fast and efficient assistance to solve your IT problems directly on site.",
          },
          security: {
            title: "Access Control and Video Surveillance",
            description: "Reliable and modern solutions to secure your premises and access.",
          },
          see_more: "See more →",
        },
        industries: {
          title: "— Industries",
          subtitle: "Solutions adapted to each sector of activity",
          description1:
        ...
        contact: {
          ...
          description: "Need help? The M-LINK team is here for you.<br>Contact us!",
          form: {
            name: "Your name",
            email: "Your email",
            phone: "Phone",
  ...
  updateContent() {
    ...
    if (titleTranslation) {
      document.title = `M-LINK - ${titleTranslation} IT`
    }
  }
